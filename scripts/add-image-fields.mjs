...
const KEYS = new Set(['uno','skyjow','taboo','quiz','yahtzee','puissance4','just_one','battleship','diamant','ludo','perudo','cant_stop','mille_bornes','atlantide','impostor','spyfall','snake','pacman','breakout','tetris','sutom','space_invaders','2048','flappy_bird','plumber','abalone','blokus','six_qui_prend','complot','tanks','duel','match3','dames']);
