...
const GAMES = {
  ...
  breakout:      { c: 'a classic arcade Breakout scene, several neat horizontal rows of bright multicolor rectangular bricks red orange yellow green blue filling the top, a glossy paddle at the bottom centre and one ball bouncing up with a light trail, deep blue background, iconic and clearly recognizable', i: 'a ball and paddle with a few colorful bricks, neon gradient' },
  ...
  plumber:       { c: 'a bright cheerful side-scrolling platformer scene with no characters and no people, a row of shiny spinning gold coins arcing through the air, glossy green warp pipes, floating stone brick platforms and blocks, blue sky with fluffy white clouds, clean glossy 2.5D mobile game art, iconic coin-collecting platformer level, recognizable (no humanoid mascot — Flux turns any cartoon plumber into Mario)', i: 'a shiny gold coin with a star, bright red-and-green gradient' },
  ...
  blokus:        { c: 'a classic Blokus board seen from above, a clean square grid filling with flat interlocking red blue green yellow polyomino pieces spreading from the four corners and touching corner-to-corner, tidy geometric and recognizable', i: 'a few colorful polyomino pieces touching at a single corner, bright gradient' },
