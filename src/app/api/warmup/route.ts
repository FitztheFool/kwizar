...
const ALLOWED_ENV_KEYS = [
    ...
    'NEXT_PUBLIC_PUISSANCE4_SERVER_URL',
    ...
    'NEXT_PUBLIC_ATLANTIDE_SERVER_URL',
    'NEXT_PUBLIC_ABALONE_SERVER_URL',
    'NEXT_PUBLIC_BLOKUS_SERVER_URL',
    ...
    'NEXT_PUBLIC_BACKGAMMON_SERVER_URL',
];
