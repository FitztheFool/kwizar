...
export const GAME_CONFIG = {
    ...
    puissance4: {
        ...
        label: 'Puissance 4',
        image: '/puissance4/board/board.png',
        mode: 'both' as const,
        higherIsBetter: true,
    ...
    battleship: {
        ...
        mode: 'both' as const,
        image: '/battleship/board/board.png',
        higherIsBetter: true,
        scoreLabel: 'Victoires',
