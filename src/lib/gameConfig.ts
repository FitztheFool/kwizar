...
export const GAME_CONFIG = {
    ...
    backgammon: {
        gameType: 'BACKGAMMON' as const,
        bot: true,
        noOptions: 'Backgammon — solo (vs bot) ou 2 joueurs.',
        label: 'Backgammon',
        mode: 'both' as const,
        higherIsBetter: true,
        scoreLabel: 'Victoires',
        description: "Le plus ancien des jeux de course, entre dés et stratégie. Avance tes 15 pions, frappe les blots adverses et sors tout le premier.",
        players: 'vs bot ou 2j',
        rules: "<p>But : sortir ses 15 pions du plateau avant l'adversaire.</p><ul><li>À ton tour, lance 2 dés et avance tes pions d'autant de flèches — un double se joue 4 fois.</li><li>Une flèche occupée par 2 pions adverses ou plus est bloquée.</li><li>Un pion adverse seul (blot) est frappé : il repart de la barre et doit rentrer avant tout autre coup.</li><li>Tu dois jouer le maximum de dés possible ; si un seul est jouable, ce doit être le plus grand.</li><li>Quand tes 15 pions sont dans ton jan intérieur, sors-les avec des dés exacts (ou supérieurs pour le pion le plus éloigné).</li></ul>",
        score: "1 point par victoire. Classement ELO.",
    },
    duel: {
