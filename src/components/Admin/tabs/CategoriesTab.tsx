                    ...
                    {categories.map(cat => (
                        <li key={cat.id} className="flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors gap-3">
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                                {editing?.id === cat.id ? (
                                    <>
                                        <button onClick={() => { onRename(editing.id, editing.name); setEditing(null); }} className="inline-flex items-center gap-1 text-[10px] font-semibold text-white bg-accent-gradient hover:brightness-110 px-2 py-1 rounded-lg transition-colors">
                                    ...
                                    <>
                                        <button onClick={() => setEditing({ id: cat.id, name: cat.name })} className="inline-flex items-center gap-1 text-[10px] font-semibold text-primary-600 dark:text-primary-400 px-2 py-1 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors border border-blue-200 dark:border-blue-800">
