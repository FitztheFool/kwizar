...
function GroupSelect({ value, onChange, groups, placeholder }: {
    ...
    return (
        <select
            ...
            className="text-sm border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
        >
    ...
    return (
        <li className="flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors gap-3">
            ...
            <div className="flex items-center gap-1 shrink-0">
                {isEditing ? (
                    <>
                        <button onClick={onSaveWord} className="inline-flex items-center gap-1 text-[10px] font-semibold text-white bg-accent-gradient hover:brightness-110 px-2 py-1 rounded-lg transition-colors">
                    ...
                    <>
                        <button
                            ...
                            className="inline-flex items-center gap-1 text-[10px] font-semibold text-primary-600 dark:text-primary-400 px-2 py-1 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors border border-blue-200 dark:border-blue-800"
                        >
        ...
        <div id="admin-words" className="scroll-mt-24 space-y-4">
            ...
            <div className="rounded-xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3 flex flex-wrap gap-2 items-center">
                <input
                    ...
                    className="w-32 text-sm border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
                <input
                    type="text"
                    ...
                    onKeyDown={e => e.key === 'Enter' && onAddWord()}
                    className="flex-1 min-w-[160px] text-sm border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
