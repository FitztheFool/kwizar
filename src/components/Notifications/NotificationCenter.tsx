...
export default function NotificationCenter() {
    ...
    return (
        <div className="relative shrink-0" ref={ref}>
            ...
            {open && (
                <div role="dialog" aria-label="Notifications" className="fixed inset-x-2 top-16 w-auto sm:absolute sm:inset-x-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-80 max-h-[70vh] overflow-y-auto rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl z-[70]">
